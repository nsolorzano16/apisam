    ...
    public class ConsultaController : ControllerBase
    {
        ...
        public IActionResult GetExpedientePdf([FromRoute] int pacienteId, [FromRoute] string doctorId)
        {
            ...
            Paragraph antecedentesFamiliares = new Paragraph("Antecedentes Familiares").SetTextAlignment(TextAlignment.CENTER).SetFontSize(16).SetBold();
                ...
                Paragraph antecedentesPatFamiliares = new Paragraph(new Text($@" {
                    _expediente.AntecedentesFamiliaresPersonales.AntecedentesPatologicosFamiliares ?? ""}")).SetTextAlignment(TextAlignment.JUSTIFIED);
            ...
            if (_expediente.Consultas.Count > 0)
            {
                ...
                _expediente.Consultas.ForEach(consulta =>
                {
                    ...
                    if (consulta.ConsultaGeneral != null)
                    {
                        ...
                        Paragraph fog = new Paragraph($"{consulta.ConsultaGeneral.Fog ?? ""}").SetTextAlignment(TextAlignment.JUSTIFIED);
